...
<div class="row">
  ...
  <form action="insertcart.php" method="POST">
      <div class="card">
  <a href="desc/bottleguard.html"><img src="img\bottle guard.jpg" style="width:100%"></a>
  <h1>Fresh Bottle Guard</h1>
  <p class="price">MRP=Rs10.0/KG</p>
  <input type="text" name="quantity" placeholder="In KG only" required>
  <input type="hidden" name="name" value="bottleguard">
  ...
  <p> <button>Add to Cart</button></p>
   ...
   <form action="insertcart.php" method="POST">
  <div class="card">
  <a href="desc/broccoli.html"><img src="img\broccoli.jpg" style="width:100%"></a>
  <h1>Fresh Broccoli</h1>
  <p class="price">MRP=Rs10.0/KG</p>
   <input type="text" name="quantity" placeholder="In KG only"required>
  <input type="hidden" name="name" value="Broccoli">
  <input type="hidden" name="price" value="10">
  <p><button >  Add to Cart</button></p>
  ...
  <form action="insertcart.php" method="POST">
  <div class="card">
  <a href="desc/capsicum.html"><img src="img\capsicum.jpg" style="width:100%"></a>
  <h1>Fresh Capsicums</h1>
  <p class="price">MRP=Rs10.0/KG</p>
  <input type="text" name="quantity" placeholder="In KG only"required>
  <input type="hidden" name="name" value="Capsicums">
  <input type="hidden" name="price" value="10">
  <p><button>Add to Cart </button></p>
  </div>
  </form>
...
<form action="insertcart.php" method="POST">
 ...
 <form action="insertcart.php" method="POST">
  <div class="card">
  <a href="desc/potatoes.html"><img src="img\potatoes.jpg" style="width:100%"></a>
  <h1>Potatoes</h1>
  <p class="price">MRP=Rs10.0/KG</p>
  <input type="text" name="quantity" placeholder="In KG only"required>
  <input type="hidden" name="name" value="Potatoes">
  <input type="hidden" name="price" value="10">
  <p><button>Add to Cart </button></p> 
  </div>
 ...
 <form action="insertcart.php" method="POST">
  ...
  <form action="insertcart.php" method="POST">
   <div class="card">
  <a href="desc/brinjals.html"><img src="img\brinjal.jpg" style="width:100%"></a>
  <h1>Fresh Brinjals</h1>
  <p class="price">MRP=Rs10.0/KG</p>
  <input type="text" name="quantity" placeholder="In KG only"required>
  <input type="hidden" name="name" value="Brinjals">
  <input type="hidden" name="price" value="10">
  <p><button>Add to Cart </button></p>
  </div>  
  </form> 
