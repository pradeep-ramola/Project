  ...
  <div class="col-75">
    <div class="container">
      <form action="load.php" method="post">
        ...
        <div class="row">
          <div class="col-50">
            ...
            <input type="text" id="fname" name="firstname" placeholder="Swapnil Joshi"required>
          ...
          <div class="col-50">
            ...
            <input type="text" id="cname" name="cardname" placeholder="abc"required>
      ...
      <center><b>OR</b></center>
       <a href="virtual.html"> <input type="submit" value="Take from store" class="btn"></a>
    </div>
  </div>
</div>
